...
***PLEASE NOTE***
This version is a specific 
experimental setup where model input is restricted
to using the avaliable H3K27Ac feature values only.
This is in place for training, validation, testing and 
gene prediction.
