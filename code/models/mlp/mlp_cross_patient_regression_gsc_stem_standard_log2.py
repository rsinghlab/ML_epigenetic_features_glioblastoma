...
def superenhancer_associated_genes_perturbation(model, X_test, Y_test, batch_size, gene_names_in_test_set):    
    ...
    perturbation_results  = model.evaluate(X_test, Y_test, batch_size=batch_size)
    loss_results.append(perturbation_results[0])
    PCC_results.append(perturbation_results[1])
    ...
    print('loss results (after perturbation),',loss_results[0])
    
    return PCC_results, SCC_results, R2_results, loss_results, X_test
...
def main(loss_dict, pcc_dict, r2_score_dict, scc_dict, val_loss_dict, val_pcc_dict, val_r2_score_dict, val_scc_dict, gene_dict, num_genes, count, batch_size, learning_rate, hidden_size_1, hidden_size_2, hidden_size_3, dropout_rate):
    ...
    #visualize_individual_input_profiles(X_test, prediction_se, Y_test, Y_pred, highly_expressed_low_mse_group, lowly_expessed_low_mse_group, highly_expressed_high_mse_group, lowly_expressed_high_mse_group, gene_names_in_test_set)
...
if __name__ == '__main__':
    ...
    # For testing new tuning in GSC2-GSC1 direction
    #parameters = dict(learning_rate_vals = [1e-3], batch_size_vals = [512], hidden_size_1 = [200], hidden_size_2 = [50], hidden_size_3 = [50], dropout_rate = [0.5])
    
    parameters = dict(learning_rate_vals = [1e-4], batch_size_vals = [512], hidden_size_1 = [100], hidden_size_2 = [100], hidden_size_3 = [200], dropout_rate = [0.4])
    #GOOD
    #parameters = dict(learning_rate_vals = [1e-3], batch_size_vals = [512], hidden_size_1 = [200], hidden_size_2 = [100], hidden_size_3 = [200], dropout_rate = [0.3])
    #parameters = dict(learning_rate_vals = [1e-4], batch_size_vals = [1024], hidden_size_1 = [200], hidden_size_2 = [200], hidden_size_3 = [200], dropout_rate = [0.4])

    # Hyperparameter grid search
    #parameters = dict(learning_rate_vals = [1e-2, 5e-2, 1e-3, 5e-3, 5e-4, 1e-4], batch_size_vals = [512, 1024], hidden_size_1 = [200, 100, 50, 20], hidden_size_2 = [200, 100, 50, 20], hidden_size_3 = [200, 100, 50, 20], dropout_rate = [0.3, 0.4, 0.5])
